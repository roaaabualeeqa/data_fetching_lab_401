...
function Toast({ message, handleClose }) {
    ...
    return (
        <>
            <section id="toast-default" className="fixed z-40 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow-inner shadow-blue-500 right-10 bottom-10" role="alert">
